    ...
    <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-20">
            ...
            <div class="mt-6 text-gray-600 text-left">
                <p class="text-sm mb-2 text-red-400">品名・品番/JANコードから検索されます。</p>
        ...
        <div class="lg:w-full w-full mx-auto overflow-auto">
            <table class="table-auto w-full text-left whitespace-no-wrap">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-200 my-4 hover:bg-slate-200 transition {{ $stock->del_flg ? 'bg-red-100' : '' }}">
                        <td class="w-24 px-4 py-8 text-lg text-gray-900"><a href="{{ route('stock.show.stocks', ['stock_id' => $stock->id ]) }}" class="hover:text-blue-200"><img class="w-16" src="{{ $stock->img_path && strpos($stock->img_path, 'https://') !== false ? $stock->img_path : 'https://akioka.cloud/' . $stock->img_path }}" alt=""></a></td>
                        ...
                        <td class="px-4 py-8 text-lg text-gray-400">
                            <a href="{{ route('stock.show.stocks', ['stock_id' => $stock->id ]) }}">
