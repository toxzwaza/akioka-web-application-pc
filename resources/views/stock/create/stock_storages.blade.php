            ...
            <div class="flex items-start mt-8">
                <div class="px-8 w-1/2 border-r border-gray-200 text-left">
                    ...
                    <form class="w-full" action="{{ route('stock.locations.create') }}">
                        <input type="text" name="" id="" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring">
                ...
                <div class="px-8 w-1/2 border-r border-gray-200">
                    ...
                    <form class="w-full text-left" action="{{ route('stock.storage_address.create') }}">
                        <div class="sm:col-span-2 mb-4">
                            ...
                            <select name="" id="location_select" class="w-1/2 rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring">
                        ...
                        <div class="sm:col-span-2 mb-4">
                            <label for="email" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">アドレス*</label><br>
                            <input type="text" name="" id="" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring">
                        </div>
                        ...
                        <div class="w-full mt-8">
                            ...
                            <div id="badge_container" class="flex items-center flex-wrap">
            ...
            <table class="table-auto w-full text-left whitespace-no-wrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-4">{{ $location->name }}</td>
