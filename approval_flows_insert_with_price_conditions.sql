...
-- ステップ設定
INSERT INTO approval_flow_steps (approval_flow_id, step_order, approver_user_id, is_required, created_at, updated_at) VALUES
(@flow_id, 1, 16, true, NOW(), NOW());  -- 梶谷課長（自分自身）
...
-- ステップ設定
INSERT INTO approval_flow_steps (approval_flow_id, step_order, approver_user_id, is_required, created_at, updated_at) VALUES
(@flow_id, 1, 37, true, NOW(), NOW());  -- 長谷川課長（自分自身）
...
-- ステップ設定
INSERT INTO approval_flow_steps (approval_flow_id, step_order, approver_user_id, is_required, created_at, updated_at) VALUES
(@flow_id, 1, 84, true, NOW(), NOW());  -- 宮原課長（自分自身）
...
ORDER BY af.id;
-- 不足している新規品の承認フローを追加するSQL
-- 品証・技術・製造一課・製造二課・保全課の新規品承認フロー

-- 1. 技術部 係長・GL・一般 新規品承認フロー

-- 1-1. 技術部 係長・GL・一般 新規品発注承認フロー（10,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('技術部 係長・GL・一般 新規品発注承認フロー（10,000円未満）', '技術部の係長・GL・一般からの新規品発注承認フロー（10,000円未満）', true, NOW(), NOW());
...
-- 1-2. 技術部 係長・GL・一般 新規品発注承認フロー（10,000円以上150,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('技術部 係長・GL・一般 新規品発注承認フロー（10,000円以上150,000円未満）', '技術部の係長・GL・一般からの新規品発注承認フロー（10,000円以上150,000円未満）', true, NOW(), NOW());
...
-- 1-3. 技術部 係長・GL・一般 新規品発注承認フロー（150,000円以上）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('技術部 係長・GL・一般 新規品発注承認フロー（150,000円以上）', '技術部の係長・GL・一般からの新規品発注承認フロー（150,000円以上）', true, NOW(), NOW());
...
-- 2. 品証部 係長・GL・一般 新規品承認フロー

-- 2-1. 品証部 係長・GL・一般 新規品発注承認フロー（10,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('品証部 係長・GL・一般 新規品発注承認フロー（10,000円未満）', '品証部の係長・GL・一般からの新規品発注承認フロー（10,000円未満）', true, NOW(), NOW());
...
-- 2-2. 品証部 係長・GL・一般 新規品発注承認フロー（10,000円以上150,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('品証部 係長・GL・一般 新規品発注承認フロー（10,000円以上150,000円未満）', '品証部の係長・GL・一般からの新規品発注承認フロー（10,000円以上150,000円未満）', true, NOW(), NOW());
...
-- 2-3. 品証部 係長・GL・一般 新規品発注承認フロー（150,000円以上）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('品証部 係長・GL・一般 新規品発注承認フロー（150,000円以上）', '品証部の係長・GL・一般からの新規品発注承認フロー（150,000円以上）', true, NOW(), NOW());
...
-- 3. 製造一課 係長・GL・一般 新規品承認フロー

-- 3-1. 製造一課 係長・GL・一般 新規品発注承認フロー（10,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('製造一課 係長・GL・一般 新規品発注承認フロー（10,000円未満）', '製造一課の係長・GL・一般からの新規品発注承認フロー（10,000円未満）', true, NOW(), NOW());
...
-- 3-2. 製造一課 係長・GL・一般 新規品発注承認フロー（10,000円以上150,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('製造一課 係長・GL・一般 新規品発注承認フロー（10,000円以上150,000円未満）', '製造一課の係長・GL・一般からの新規品発注承認フロー（10,000円以上150,000円未満）', true, NOW(), NOW());
...
-- 3-3. 製造一課 係長・GL・一般 新規品発注承認フロー（150,000円以上）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('製造一課 係長・GL・一般 新規品発注承認フロー（150,000円以上）', '製造一課の係長・GL・一般からの新規品発注承認フロー（150,000円以上）', true, NOW(), NOW());
...
-- 4. 製造二課 係長・GL・一般 新規品承認フロー

-- 4-1. 製造二課 係長・GL・一般 新規品発注承認フロー（10,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('製造二課 係長・GL・一般 新規品発注承認フロー（10,000円未満）', '製造二課の係長・GL・一般からの新規品発注承認フロー（10,000円未満）', true, NOW(), NOW());
...
-- 4-2. 製造二課 係長・GL・一般 新規品発注承認フロー（10,000円以上150,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('製造二課 係長・GL・一般 新規品発注承認フロー（10,000円以上150,000円未満）', '製造二課の係長・GL・一般からの新規品発注承認フロー（10,000円以上150,000円未満）', true, NOW(), NOW());
...
-- 4-3. 製造二課 係長・GL・一般 新規品発注承認フロー（150,000円以上）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('製造二課 係長・GL・一般 新規品発注承認フロー（150,000円以上）', '製造二課の係長・GL・一般からの新規品発注承認フロー（150,000円以上）', true, NOW(), NOW());
...
-- 5. 保全課 係長・GL・一般 新規品承認フロー

-- 5-1. 保全課 係長・GL・一般 新規品発注承認フロー（150,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('保全課 係長・GL・一般 新規品発注承認フロー（150,000円未満）', '保全課の係長・GL・一般からの新規品発注承認フロー（150,000円未満）', true, NOW(), NOW());
...
-- 5-2. 保全課 係長・GL・一般 新規品発注承認フロー（150,000円以上）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('保全課 係長・GL・一般 新規品発注承認フロー（150,000円以上）', '保全課の係長・GL・一般からの新規品発注承認フロー（150,000円以上）', true, NOW(), NOW());
...
-- 6. 課長からの新規品承認フロー（自己承認を修正）

-- 6-1. 品証課長 新規品発注承認フロー（10,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('品証課長 新規品発注承認フロー（10,000円未満）', '品証課長からの新規品発注承認フロー（10,000円未満）', true, NOW(), NOW());
...
-- 6-2. 品証課長 新規品発注承認フロー（10,000円以上150,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('品証課長 新規品発注承認フロー（10,000円以上150,000円未満）', '品証課長からの新規品発注承認フロー（10,000円以上150,000円未満）', true, NOW(), NOW());
...
-- 6-3. 品証課長 新規品発注承認フロー（150,000円以上）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('品証課長 新規品発注承認フロー（150,000円以上）', '品証課長からの新規品発注承認フロー（150,000円以上）', true, NOW(), NOW());
...
-- 6-4. 製造一課課長 新規品発注承認フロー（10,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('製造一課課長 新規品発注承認フロー（10,000円未満）', '製造一課課長からの新規品発注承認フロー（10,000円未満）', true, NOW(), NOW());
...
-- 6-5. 製造一課課長 新規品発注承認フロー（10,000円以上150,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('製造一課課長 新規品発注承認フロー（10,000円以上150,000円未満）', '製造一課課長からの新規品発注承認フロー（10,000円以上150,000円未満）', true, NOW(), NOW());
...
-- 6-6. 製造一課課長 新規品発注承認フロー（150,000円以上）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('製造一課課長 新規品発注承認フロー（150,000円以上）', '製造一課課長からの新規品発注承認フロー（150,000円以上）', true, NOW(), NOW());
...
-- 6-7. 製造二課課長 新規品発注承認フロー（10,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('製造二課課長 新規品発注承認フロー（10,000円未満）', '製造二課課長からの新規品発注承認フロー（10,000円未満）', true, NOW(), NOW());
...
-- 6-8. 製造二課課長 新規品発注承認フロー（10,000円以上150,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('製造二課課長 新規品発注承認フロー（10,000円以上150,000円未満）', '製造二課課長からの新規品発注承認フロー（10,000円以上150,000円未満）', true, NOW(), NOW());
...
-- 6-9. 製造二課課長 新規品発注承認フロー（150,000円以上）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('製造二課課長 新規品発注承認フロー（150,000円以上）', '製造二課課長からの新規品発注承認フロー（150,000円以上）', true, NOW(), NOW());
...
-- 7. 品証・技術の既存品承認フロー（新規品のみ承認フローが必要、既存品は承認不要）

-- 7-1. 品証部 係長・GL・一般 既存品発注承認フロー（承認不要）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('品証部 係長・GL・一般 既存品発注承認フロー（承認不要）', '品証部の係長・GL・一般からの既存品発注承認フロー（承認不要）', true, NOW(), NOW());
...
-- 7-2. 技術部 係長・GL・一般 既存品発注承認フロー（承認不要）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('技術部 係長・GL・一般 既存品発注承認フロー（承認不要）', '技術部の係長・GL・一般からの既存品発注承認フロー（承認不要）', true, NOW(), NOW());
...
-- 7-3. 品証課長 既存品発注承認フロー（承認不要）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('品証課長 既存品発注承認フロー（承認不要）', '品証課長からの既存品発注承認フロー（承認不要）', true, NOW(), NOW());
...
-- 7-4. 技術課長 既存品発注承認フロー（承認不要）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('技術課長 既存品発注承認フロー（承認不要）', '技術課長からの既存品発注承認フロー（承認不要）', true, NOW(), NOW());
...
LEFT JOIN approval_flow_steps afs ON af.id = afs.approval_flow_id
LEFT JOIN approval_flow_conditions afc ON af.id = afc.approval_flow_id
WHERE af.name LIKE '%新規品%' OR af.name LIKE '%既存品%'
GROUP BY af.id, af.name, af.description, af.is_active
ORDER BY af.id;
