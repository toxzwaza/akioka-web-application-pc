...
-- 1-17. 総務部 係長・GL・一般 発注承認フロー（新規品・150,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('総務部 係長・GL・一般 発注承認フロー（新規品・150,000円未満）', '総務部の係長・GL・一般からの発注承認フロー（新規品・150,000円未満）', true, NOW(), NOW());
...
-- 1-18. 総務部 係長・GL・一般 発注承認フロー（新規品・150,000円以上）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('総務部 係長・GL・一般 発注承認フロー（新規品・150,000円以上）', '総務部の係長・GL・一般からの発注承認フロー（新規品・150,000円以上）', true, NOW(), NOW());
...
-- 1-19. 業務部 係長・GL・一般 発注承認フロー（150,000円未満）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('業務部 係長・GL・一般 発注承認フロー（150,000円未満）', '業務部の係長・GL・一般からの発注承認フロー（150,000円未満）', true, NOW(), NOW());
...
-- 1-20. 業務部 係長・GL・一般 発注承認フロー（150,000円以上）
INSERT INTO approval_flows (name, description, is_active, created_at, updated_at) VALUES
('業務部 係長・GL・一般 発注承認フロー（150,000円以上）', '業務部の係長・GL・一般からの発注承認フロー（150,000円以上）', true, NOW(), NOW());
